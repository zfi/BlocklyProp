...
public class FriendRequest extends TableImpl<FriendRequestRecord> {
    ...
    private static final long serialVersionUID = 399992337;
     ...
     */
    public final TableField<FriendRequestRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<FriendRequestRecord, Timestamp> REQUESTED = createField("requested", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>blocklyprop.friend_request.request_sent_count</code>.
     */
    public final TableField<FriendRequestRecord, Integer> REQUEST_SENT_COUNT = createField("request_sent_count", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>blocklyprop.friend_request.request_last_sent</code>.
     */
    public final TableField<FriendRequestRecord, Timestamp> REQUEST_LAST_SENT = createField("request_last_sent", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>blocklyprop.friend_request.refused</code>.
     */
    public final TableField<FriendRequestRecord, Boolean> REFUSED = createField("refused", org.jooq.impl.SQLDataType.BIT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("b'0'", org.jooq.impl.SQLDataType.BIT)), this, "");

    /**
     * Create a <code>blocklyprop.friend_request</code> table reference
     */
    public FriendRequest() {
        this(DSL.name("friend_request"), null);
    }
    ...
    public FriendRequest(String alias) {
        this(DSL.name(alias), FRIEND_REQUEST);
    }

    /**
     * Create an aliased <code>blocklyprop.friend_request</code> table reference
     */
    public FriendRequest(Name alias) {
        this(alias, FRIEND_REQUEST);
    }

    private FriendRequest(Name alias, Table<FriendRequestRecord> aliased) {
        this(alias, aliased, null);
    }

    private FriendRequest(Name alias, Table<FriendRequestRecord> aliased, Field<?>[] parameters) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FRIEND_REQUEST_FRIEND_REQUEST_IDREQUESTUSER_IDREQUESTEDUSER_UINDEX, Indexes.FRIEND_REQUEST_FRIEND_REQUEST_REQUESTED_USER_ID_FK, Indexes.FRIEND_REQUEST_PRIMARY);
    }
    ...
    public FriendRequest as(String alias) {
        return new FriendRequest(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public FriendRequest as(Name alias) {
    ...
    public FriendRequest rename(String name) {
        return new FriendRequest(DSL.name(name), null);
    }
     ...
     */
    @Override
    public FriendRequest rename(Name name) {
